...
# 子階層（スポーツ・レジャー）
sports_leisure_1  = sport_leisure.children.create(name: "ゴルフ")
sports_leisure_2  = sport_leisure.children.create(name: "フィッシング")
sports_leisure_3  = sport_leisure.children.create(name: "自転車")
sports_leisure_4  = sport_leisure.children.create(name: "トレーニング/エクササイズ")
sports_leisure_5  = sport_leisure.children.create(name: "野球")
sports_leisure_6  = sport_leisure.children.create(name: "サッカー/フットサル")
sports_leisure_7  = sport_leisure.children.create(name: "テニス")
sports_leisure_8  = sport_leisure.children.create(name: "スノーボード")
sports_leisure_9  = sport_leisure.children.create(name: "スキー")
sports_leisure_10 = sport_leisure.children.create(name: "その他スポーツ")
sports_leisure_11 = sport_leisure.children.create(name: "アウトドア")
sports_leisure_12 = sport_leisure.children.create(name: "その他")
