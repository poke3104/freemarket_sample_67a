...
interior_housing_accessories = Category.create(name: "インテリア・住まい・小物")
...
appliances_smartphone_camera = Category.create(name: "家電・スマホ・カメラ")
sports_leisure               = Category.create(name: "スポーツ・レジャー")
handmade                     = Category.create(name: "ハンドメイド")
ticket                       = Category.create(name: "チケット")
automobile_motorcycle        = Category.create(name: "自動車・オートバイ")
...
lady_7  = lady.children.create(name: "ルームウェア")
...
lady_12 = lady.children.create(name: "ヘアアクセサリ")
...
# 孫階層（レディース）
lady_1.children.create([{name: "Tシャツ/カットソー(半袖/袖なし)"}, {name: "Tシャツ/カットソー(七分/長袖)"}, {name: "シャツ/ブラウス(半袖/袖なし)"}, {name: "シャツ/ブラウス(７分/長袖)"}, {name: "ポロシャツ"}, {name: "キャミソール"}, {name: "タンクトップ"}, {name: "ホルターネック"}, {name: "ニット/セーター"}, {name: "チュニック"}, {name: "カーディガン/ボレロ"}, {name: "アンサンブル"}, {name: "ベスト/ジレ"}, {name: "パーカー"}])
lady_2.children.create([{name: "テーラードジャケット"}, {name: "ノーカラージャケット"}, {name: "Gジャン/デニムジャケット"}, {name: "レザージャケット"}, {name: "ダウンジャケット"}, {name: "ライダーズジャケット"}, {name: "ミリタリージャケット"}, {name: "ダウンベスト"}, {name: "ジャンパー/ブルゾン"}, {name: "ポンチョ"}, {name: "ロングコート"}, {name: "トレンチコート"}, {name: "ダッフルコート"}, {name: "ピーコート"}])
lady_3.children.create([{name: "デニム/ジーンズ"}, {name: "ショートパンツ"}, {name: "カジュアルパンツ"}, {name: "ハーフパンツ"}, {name: "チノパンツ"}, {name: "ワークパンツ/カーゴパンツ"}, {name: "クロップパンツ"}, {name: "サロペット/オーバーオール"}, {name: "オールインワン"}, {name: "サルエルパンツ"}, {name: "ガウチョパンツ"}, {name: "その他"}])
...
# 子階層（インテリア・住まい・小物）
interior_housing_accessories_1  = interior_housing_accessories.children.create(name: "キッチン/食器")
interior_housing_accessories_2  = interior_housing_accessories.children.create(name: "ベッド/マットレス")
interior_housing_accessories_3  = interior_housing_accessories.children.create(name: "ソファ/ソファベッド")
interior_housing_accessories_4  = interior_housing_accessories.children.create(name: "椅子/チェア")
interior_housing_accessories_5  = interior_housing_accessories.children.create(name: "机/テーブル")
interior_housing_accessories_6  = interior_housing_accessories.children.create(name: "収納家具")
interior_housing_accessories_7  = interior_housing_accessories.children.create(name: "ラグ/カーペット/マット")
interior_housing_accessories_8  = interior_housing_accessories.children.create(name: "カーテン/ブラインド")
interior_housing_accessories_9  = interior_housing_accessories.children.create(name: "ライト/照明")
interior_housing_accessories_10 = interior_housing_accessories.children.create(name: "寝具")
interior_housing_accessories_11 = interior_housing_accessories.children.create(name: "インテリア小物")
interior_housing_accessories_12 = interior_housing_accessories.children.create(name: "季節/年中行事")
interior_housing_accessories_13 = interior_housing_accessories.children.create(name: "その他")

# 孫階層（インテリア・住まい・小物）
interior_housing_accessories_1.children.create([{name: "食器"},{name: "調理器具"},{name: "収納/キッチン雑貨"},{name: "弁当用品"},{name: "カトラリー(スプーン等)"},{name: "テーブル用品"},{name: "容器"},{name: "エプロン"},{name: "アルコールグッズ"},{name: "浄水機"},{name: "その他"}])
interior_housing_accessories_2.children.create([{name: "セミシングルベッド"},{name: "シングルベッド"},{name: "セミダブルベッド"},{name: "ダブルベッド"},{name: "ワイドダブルベッド"},{name: "クイーンベッド"},{name: "キングベッド"},{name: "脚付きマットレスベッド"},{name: "マットレス"},{name: "すのこベッド"},{name: "ロフトベッド/システムベッド"},{name: "簡易ベッド/折りたたみベッド"},{name: "収納付き"},{name: "その他"}])
interior_housing_accessories_3.children.create([{name: "ソファセット"},{name: "シングルソファ"},{name: "ラブソファ"},{name: "トリプルソファ"},{name: "オットマン"},{name: "コーナーソファ"},{name: "ビーズソファ/クッションソファ"},{name: "ローソファ/フロアソファ"},{name: "ソファベッド"},{name: "応接セット"},{name: "ソファカバー"},{name: "リクライニングソファ"},{name: "その他"}])
interior_housing_accessories_4.children.create([{name: "一般"},{name: "スツール"},{name: "ダイニングチェア"},{name: "ハイバックチェア"},{name: "ロッキングチェア"},{name: "座椅子"},{name: "折り畳みイス"},{name: "デスクチェア"},{name: "その他"}])
interior_housing_accessories_5.children.create([{name: "こたつ"},{name: "カウンターテーブル"},{name: "サイドテーブル"},{name: "センターテーブル"},{name: "ダイニングテーブル"},{name: "座卓/ちゃぶ台"},{name: "アウトドア用"},{name: "パソコン用"},{name: "事務机/学習机"},{name: "その他"}])
interior_housing_accessories_6.children.create([{name: "リビング収納"},{name: "キッチン収納"},{name: "玄関/屋外収納"},{name: "バス/トイレ収納"},{name: "本収納"},{name: "本/CD/DVD収納"},{name: "洋服タンス/押入れ収納"},{name: "電話台/ファックス台"},{name: "ドレッサー/鏡台"},{name: "棚/ラック"},{name: "ケース/ボックス"},{name: "その他"}])
interior_housing_accessories_7.children.create([{name: "ラグ"},{name: "カーペット"},{name: "ホットカーペット"},{name: "玄関/キッチンマット"},{name: "トイレ/バスマット"},{name: "その他"}])
interior_housing_accessories_8.children.create([{name: "カーテン"},{name: "ブラインド"},{name: "ロールスクリーン"},{name: "のれん"},{name: "その他"}])
interior_housing_accessories_9.children.create([{name: "蛍光灯/電球"},{name: "天井照明"},{name: "フロアスタンド"},{name: "その他"}])
...
# 子階層（家電・スマホ・カメラ）
appliances_smartphone_camera_1  = appliances_smartphone_camera.children.create(name: "スマートフォン/携帯電話")
appliances_smartphone_camera_2  = appliances_smartphone_camera.children.create(name: "スマホアクセサリー")
appliances_smartphone_camera_3  = appliances_smartphone_camera.children.create(name: "PC/タブレット")
appliances_smartphone_camera_4  = appliances_smartphone_camera.children.create(name: "カメラ")
appliances_smartphone_camera_5  = appliances_smartphone_camera.children.create(name: "テレビ/映像機器")
appliances_smartphone_camera_6  = appliances_smartphone_camera.children.create(name: "オーディオ機器")
appliances_smartphone_camera_7  = appliances_smartphone_camera.children.create(name: "美容/健康")
appliances_smartphone_camera_8  = appliances_smartphone_camera.children.create(name: "冷暖房/空調")
appliances_smartphone_camera_9  = appliances_smartphone_camera.children.create(name: "生活家電")
appliances_smartphone_camera_10 = appliances_smartphone_camera.children.create(name: "その他")

# 孫階層（家電・スマホ・カメラ）
appliances_smartphone_camera_1.children.create([{name: "スマートフォン本体"},{name: "バッテリー/充電器"},{name: "携帯電話本体"},{name: "PHS本体"},{name: "その他"}])
appliances_smartphone_camera_2.children.create([{name: "Android用ケース"},{name: "iPhone用ケース"},{name: "カバー"},{name: "イヤホンジャック"},{name: "ストラップ"},{name: "フィルム"},{name: "自撮り棒"},{name: "その他"}])
appliances_smartphone_camera_3.children.create([{name: "タブレット"},{name: "ノートPC"},{name: "デスクトップ型PC"},{name: "ディスプレイ"},{name: "電子ブックリーダー"},{name: "PC周辺機器"},{name: "PCパーツ"},{name: "その他"}])
appliances_smartphone_camera_4.children.create([{name: "デジタルカメラ"},{name: "ビデオカメラ"},{name: "レンズ(単焦点)"},{name: "レンズ(ズーム)"},{name: "フィルムカメラ"},{name: "防犯カメラ"},{name: "その他"}])
appliances_smartphone_camera_5.children.create([{name: "テレビ"},{name: "プロジェクター"},{name: "ブルーレイレコーダー"},{name: "DVDレコーダー"},{name: "ブルーレイプレーヤー"},{name: "DVDプレーヤー"},{name: "映像用ケーブル"},{name: "その他"}])
appliances_smartphone_camera_6.children.create([{name: "ポータブルプレーヤー"},{name: "イヤフォン"},{name: "ヘッドフォン"},{name: "アンプ"},{name: "スピーカー"},{name: "ケーブル/シールド"},{name: "ラジオ"},{name: "その他"}])
appliances_smartphone_camera_7.children.create([{name: "ヘアドライヤー"},{name: "ヘアアイロン"},{name: "美容機器"},{name: "電気シェーバー"},{name: "電動歯ブラシ"},{name: "その他"}])
appliances_smartphone_camera_8.children.create([{name: "エアコン"},{name: "空気清浄器"},{name: "加湿器"},{name: "扇風機"},{name: "除湿機"},{name: "ファンヒーター"},{name: "電気ヒーター"},{name: "オイルヒーター"},{name: "ストーブ"},{name: "ホットカーペット"},{name: "こたつ"},{name: "電気毛布"},{name: "その他"}])
appliances_smartphone_camera_9.children.create([{name: "冷蔵庫"},{name: "洗濯機"},{name: "炊飯器"},{name: "電子レンジ/オーブン"},{name: "調理機器"},{name: "アイロン"},{name: "掃除機"},{name: "エスプレッソマシン"},{name: "コーヒーメーカー"},{name: "衣類乾燥機"},{name: "その他"}])
appliances_smartphone_camera_10.children.create([{name: "その他"}])
...
automobile_motorcycle_2 = automobile_motorcycle.children.create(name: "自動車タイヤ/ホイール")
automobile_motorcycle_3 = automobile_motorcycle.children.create(name: "自動車パーツ")
automobile_motorcycle_4 = automobile_motorcycle.children.create(name: "自動車アクセサリー")
automobile_motorcycle_5 = automobile_motorcycle.children.create(name: "オートバイ車体")
automobile_motorcycle_6 = automobile_motorcycle.children.create(name: "オートバイパーツ")
automobile_motorcycle_7 = automobile_motorcycle.children.create(name: "オートバイアクセサリー")

# 孫階層（自動車・オートバイ）
automobile_motorcycle_1.children.create([{name: "国内自動車本体"},{name: "外国自動車本体"}])
automobile_motorcycle_2.children.create([{name: "タイヤ/ホイールセット"},{name: "タイヤ"},{name: "ホイール"},{name: "その他"}])
automobile_motorcycle_3.children.create([{name: "サスペンション"},{name: "ブレーキ"},{name: "外装、エアロパーツ"},{name: "ライト"},{name: "内装品、シート"},{name: "ステアリング"},{name: "マフラー・排気系"},{name: "エンジン、過給器、冷却装置"},{name: "クラッチ、ミッション、駆動系"},{name: "電装品"},{name: "補強パーツ"},{name: "汎用パーツ"},{name: "外国自動車用パーツ"},{name: "その他"}])
automobile_motorcycle_4.children.create([{name: "車内アクセサリー"},{name: "カーナビ"},{name: "カーオーディオ"},{name: "車外アクセサリー"},{name: "メンテナンス用品"},{name: "チャイルドシート"},{name: "ドライブレコーダー"},{name: "レーダー探知機"},{name: "カタログ/マニュアル"},{name: "セキュリティ"},{name: "ETC"},{name: "その他"}])
automobile_motorcycle_6.children.create([{name: "タイヤ"},{name: "マフラー"},{name: "エンジン、冷却装置"},{name: "カウル、フェンダー、外装"},{name: "サスペンション"},{name: "ホイール"},{name: "シート"},{name: "ブレーキ"},{name: "タンク"},{name: "ライト、ウィンカー"},{name: "チェーン、スプロケット、駆動系"},{name: "メーター"},{name: "電装系"},{name: "ミラー"},{name: "外国オートバイ用パーツ"},{name: "その他"}])
automobile_motorcycle_7.children.create([{name: "ヘルメット/シールド"},{name: "バイクウエア/装備"},{name: "アクセサリー"},{name: "メンテナンス"},{name: "カタログ/マニュアル"},{name: "その他"}])
